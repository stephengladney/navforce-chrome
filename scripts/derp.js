...
function loadContent() {
  ...
  const profileActions = document.querySelector(".dist-value");
  ...
  if (isReactDev) {
    ...
    reactFound.style =
      "background: #0bd; color: #fff; padding: 5px 10px; border-radius: 18px; font-weight: 700; margin-left: 10px;";
    ...
    reactFound.style =
      "background: #c00; color: #fff; padding: 5px 10px; border-radius: 18px; font-weight: 700; margin-left: 10px;";
